...
>
> The federation protocol can use the home domain to look up more details about a transaction's memo or [address](https://www.Triam.org/developers/learn/concepts/federation.html#triam-addresses) details about an account. For more on federation, see the [federation guide](./federation.md).
>
>
> #### Thresholds
