...
# How to contribute to a Triam project

Your contributions to the Triam network will help improve the world’s financial
infrastructure, faster.

We want to make it as easy as possible to contribute changes that
help the Triam network grow and thrive. There are a few guidelines that we
...
* [Explore the API](https://triamnetwork.github.io/triam-sdk/)
